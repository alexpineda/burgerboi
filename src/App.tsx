...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100">
                      ...
                      {project.collapsed ? (
                        <>
                          <button
                            ...
                            title="Move up"
                          >
                            <MoveUp size={20} className="text-amber-700" />
                          </button>
                          <button
                            ...
                            title="Move down"
                          >
                            <MoveDown size={20} className="text-amber-700" />
                          </button>
                        </>
                      ) : (
                        <>
      ...
      <div className="max-w-2xl mx-auto p-6 flex justify-end" style={{ justifyContent: "flex-end" }}>
        <button
